...
const translations = {
  ua: {
    ...
    faqA3: "Ви можете завантажувати публічні плейлисти розміром до 500 треків. Для великих плейлистів пакування в ZIP може зайняти кілька хвилин.",
  ...
  en: {
    ...
    faqA3: "You can download any public playlist with up to 500 tracks. For very large playlists, packing the ZIP can take a few minutes.",
